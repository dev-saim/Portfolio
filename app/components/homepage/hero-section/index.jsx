  ...
  return (
    <section className="relative flex flex-col items-center justify-between py-4 lg:py-12">
      ...
      <div className="grid grid-cols-1 items-start lg:grid-cols-2 lg:gap-12 gap-y-8">
       <div className="order-1 lg:order-1 flex flex-col items-center md:items-start justify-center p-2 pb-20 md:pb-10 lg:pt-10 text-center md:text-left">
  <h1 className="text-2xl md:text-3xl font-bold text-white md:font-extrabold lg:text-[2.3rem] leading-[2.1rem] lg:leading-[3.1rem]">
    Hi, I’m <span className="text-pink-500">{personalData.name}</span> <br />
    A dedicated <span className="text-[#16f2b3]">{personalData.designation}</span> building high-performance, adaptive, and intuitive web interfaces.
  </h1>
          ...
          <div className="overflow-hidden border-t-[2px] border-indigo-900 px-4 lg:px-8 py-4 lg:py-8">
            <code className="font-mono text-xs md:text-sm lg:text-base">
              ...
              <div>
                ...
                <span className="text-gray-400">{`'`}</span>
                <span className="text-amber-300">Saim Asif</span>
                <span className="text-gray-400">{`',`}</span>
              </div>
